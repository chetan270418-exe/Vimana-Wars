...
class LeaderboardView(arcade.View):
    ...
    def _apply_fetch_results(self, scores: list[dict], error: str | None) -> None:
        ...
        for i, row in enumerate(scores):
            ...
            t_name = arcade.Text(name_str, 160, y, COLOR_WHITE, font_size=13, bold=(i < 3))
            ...
            self._row_texts.append([t_rank, t_name, t_score, t_wave, t_diff])
    ...
    def on_draw(self) -> None:
        ...
        arcade.draw_text("WARRIOR", 160, header_y, (120, 140, 180), font_size=10, bold=True)
