...
export default function SanghaNetwork({ onNavigate }: Props) {
      ...
      try {
        ...
        if (active) {
          ...
          setCurrentLobby(previous => {
            ...
            return open.find(item => item.code === previous.code) ?? previous;
          });
        }
          ...
          <Panel variant="selected" cut={14}>
            <div className="p-6 flex flex-col gap-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                ...
                <div className="flex items-end"><VedicButton variant="primary" fullWidth disabled={busy} onClick={create}>CREATE {mode === 'duel' ? '1V1 DUEL' : 'ROOM'}</VedicButton></div>
              </div>
            </div>
          </Panel>
